...
h3. Forcing Read Repair on a Bucket 
...
To inspect a the bucket "bucket" run as follows (Bucket should be a binary and Riak node an Atom):
bucket_inpsector:inspect(<<"bucket">>, 'riak@127.0.0.1')
