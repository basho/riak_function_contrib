...
This Erlang function will copy the full or partial contents of a bucket from one Riak cluster to another or from one bucket to another bucket.

The function takes the 4 or 5 arguments depending on if you want to export the entire bucket or just a percentage of the keys:
