...
# digraph_exporter:export_digraph(server, port, bucket, digraph, boolean use object value for label). or
# digraph_exporter:export_digraph(server, port, bucket, filter_list, digraph, boolean use object value for label).
